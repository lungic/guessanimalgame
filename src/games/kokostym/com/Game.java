...
//		groupAnimals();
	...
	private Card[]  createLetterCards(){
		Vector<Card> cards = new Vector<Card>();
		cards.add(new Card("Alphabet","A","A",R.drawable.lettera,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","B","B",R.drawable.letterb,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","C","C",R.drawable.letterc,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","D","D",R.drawable.letterd,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","E","E",R.drawable.lettere,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","F","F",R.drawable.letterf,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","G","G",R.drawable.letterg,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","H","H",R.drawable.letterh,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","I","I",R.drawable.letteri,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","J","J",R.drawable.letterj,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","K","K",R.drawable.letterk,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","L","L",R.drawable.letterl,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","M","M",R.drawable.letterm,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","N","N",R.drawable.lettern,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","O","O",R.drawable.lettero,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","P","P",R.drawable.letterp,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","Q","Q",R.drawable.letterq,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","R","R",R.drawable.letterr,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","S","S",R.drawable.letters,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","T","T",R.drawable.lettert,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","U","U",R.drawable.letteru,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","V","V",R.drawable.letterv,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","W","W",R.drawable.letterw,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","X","X",R.drawable.letterx,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","Y","Y",R.drawable.lettery,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","Z","Z",R.drawable.letterz,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","Å","Å",R.drawable.letteraa,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","Ä","Ä",R.drawable.letterae,R.raw.silent_sound,R.raw.silent_voice));
		cards.add(new Card("Alphabet","Ö","Ö",R.drawable.letteroo,R.raw.silent_sound,R.raw.silent_voice));
		return (Card[])cards.toArray(new Card[cards.size()]);
	}
